...
export const SignUpPage: React.FC = () => {
  ...
  return (
    <>
      <Seo
        title="Create Account | OMU FUSION"
        description="Join OMU FUSION today. Create your account to shop premium fashion, track orders, save favorites and get exclusive offers."
      />
      <div
