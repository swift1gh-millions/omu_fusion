...
export const ContactPage: React.FC = memo(() => {
  ...
  return (
    <>
      <Seo
        title="Contact OMU FUSION | Customer Support & Inquiries"
        description="Get in touch with OMU FUSION. Contact our customer support team for orders, shipping, product inquiries or general questions. We're here to help!"
        keywords="OMU FUSION contact, customer support, fashion inquiries, order help, contact Nigerian fashion brand"
      />
