...
export const AboutPage: React.FC = () => {
  ...
  return (
    <>
      <Seo
        title="About OMU FUSION | Our Story & Mission"
        description="Learn about OMU FUSION's journey, values and commitment to premium fashion. Discover our story of bringing style and quality to Nigeria's fashion scene."
        keywords="OMU FUSION about, fashion brand story, Nigerian fashion company, premium clothing mission"
      />
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
                  ...
                  <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-8 h-full shadow-2xl">
                    ...
                    <div className="space-y-6">
                      <p className="text-gray-300 leading-relaxed text-lg">
                        Omu Fusion was born at the intersection of street
                        culture and refined craftsmanship. What started as a
                        passion for bold self-expression turned into a movement.
                        Our style lives in contrast. raw yet polished, familiar
                        yet forward-thinking. Every drop is designed with
                        intention, crafted to empower individuality and elevate
                        everyday wear.
                      </p>
                      <p className="text-gray-300 leading-relaxed text-lg">
                        Our journey has been driven by a relentless pursuit of
                        excellence and an unwavering commitment to our
                        customers. Every product we create is a testament to our
                        belief that great design should be accessible to
                        everyone.
                      </p>
                      <p className="text-gray-300 leading-relaxed text-lg">
            ...
            <motion.div
              ...
              <motion.div variants={itemVariants} className="text-center mb-12">
                ...
                <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
                  The passionate individuals behind OMU FUSION who make our
                  vision a reality.
                </p>
              </motion.div>
