...
export const SignInPage: React.FC = () => {
  ...
  return (
    <>
      <Seo
        title="Sign In | OMU FUSION"
        description="Sign in to your OMU FUSION account. Access your profile, orders, wishlist and enjoy a personalized shopping experience."
      />
      <div
